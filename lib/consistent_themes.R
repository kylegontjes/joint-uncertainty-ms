...
# TNSNE cluster scale
tnsecluster_colors <- c("1" = "#E41A1C","2" = "#377EB8","3" = "#4DAF4A","4" = "#984EA3","5" = "#FF7F00","6" = "#FFFF33","0" = "gray" )
tnsecluster_colors_labels <- names(tnsecluster_colors)
tnsecluster_scale <- scale_color_manual(values=tnsecluster_colors,breaks = tnsecluster_colors_labels,labels = tnsecluster_colors_labels,name="Cluster", guide = guide_legend(order=2,ncol=1, title.position = "top", label.position = "right"))
tnsecluster_scale_fill <- scale_fill_manual(values=tnsecluster_colors,breaks = tnsecluster_colors_labels,labels = tnsecluster_colors_labels,name="Cluster", guide = guide_legend(order=2,ncol=1, title.position = "top", label.position = "right"))
