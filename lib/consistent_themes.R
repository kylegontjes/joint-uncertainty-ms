...
phylogenetic_reconstruction_scale <- scale_fill_manual(values = RColorBrewer::brewer.pal(8,"Set1"),breaks =  phylogenetic_reconstruction_cluster_names,name = "Phenotype axis",guide_legend(nrow=1))
phylogenetic_reconstruction_numeric_scale <- scale_fill_manual(values = RColorBrewer::brewer.pal(8,"Set1"),breaks =  phylogenetic_reconstruction_cluster_numeric,name = "Phenotype axis",guide_legend(nrow=1))
