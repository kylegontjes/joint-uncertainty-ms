...
# Merged table
```{r}
table <- left_join(cluster_stats,transition_stats) 
...
colnames(table) <- c("Phenotype axis","Phylogentic events","Singletons","Singleton isolates","Clusters","Cluster isolates","Cluster size (median)","Transitions","Gain events","Gains (tip)","Loss events","Losses (tip)","Continuations of trait")
