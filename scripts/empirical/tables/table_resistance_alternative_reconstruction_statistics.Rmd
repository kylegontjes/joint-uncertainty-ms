...
colnames(table) <- c("Phenotype axis","Reconstructions","Phylogentic events","Singletons","Singleton isolates","Clusters","Cluster isolates","Cluster size (median)","Cluster size (max)","Transitions","Gain events","Gains (tip)","Loss events","Losses (tip)","Continuations of trait")
