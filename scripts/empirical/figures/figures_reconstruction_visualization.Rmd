...
nodelabels(pch = 21,  cex = 0.75, bg = c("white", "grey70")[focal$states], col = "grey70") 
tiplabels(pch = 22,  cex = 0.5, bg = c("white", "grey70")[focal$tip.states], col = "grey70",tip = c(1:Ntip(phy)))  
nodelabels(pch = 21,  cex = 0.75, bg = c("white", "black")[focal$states][nodes_number], col = "black",node = sort(nodes_to_col))
tiplabels(pch = 22,  cex = 0.5, bg = c("white", "black")[focal$tip.states][tips_to_keep], col = "black",tip = c(1:Ntip(phy))[tips_to_keep])  
...
pdf("./figures/empirical/empirical_joint_uncertainty_important_nodes.pdf", width = 10.5, height = 10.5)
par(mfrow=c(1,1))
