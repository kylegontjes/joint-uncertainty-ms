...
clustering_6 <- readRDS("./data/empirical/joint_reconstruction/hclust_consensus_distance_matrix_six_clusters_string.RDS") 
...
```{r}
# Cluster assignments
cluster_assignments <- clustering_6
...
# Empirical tSNE plot
## Removed as we no longer use tSNE
#```{r tsne} 
