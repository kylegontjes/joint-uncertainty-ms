...
clustering_stats <- readRDS("./data/empirical/phyloAMR/representative_joint_uncertainty_asr_clustering_analyses.RDS")
...
ggsave("./figures/empirical/ancestral_states_on_phylogeny.png",dpi = 600,bg = 'white',plot = tracing_states_on_tree,width=12.5,height=10)
```
