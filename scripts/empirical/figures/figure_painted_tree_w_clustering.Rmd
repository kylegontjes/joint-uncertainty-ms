...
tracing_states_on_tree_wo_legend <- cowplot::plot_grid(plotlist = painted_trees_w_cluster_calls_wo_legends,nrow=3,labels =c("Best joint reconstruction",paste0("Reconstruction axis ",1:n_clusters,"    ")),label_x = -0.25,label_size = 14)
...
# Save
```{r, save}
ggsave("./figures/empirical/ancestral_states_on_phylogeny.png",dpi = 900,bg = 'white',plot = tracing_states_on_tree,width=12.5,height=12.5)
```
