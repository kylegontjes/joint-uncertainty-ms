...
phen_colors <- setNames(
  brewer.pal(length(unique(dbcluster_names)) +1, "Set1"),
...
A <- Heatmap(
  ...
  name = "No. concordant transitions"
) 
```
...
B <- Heatmap(
  ...
  right_annotation = rowannots,
  top_annotation = colannots,
  name = "No. discordant transitions"
) 
``` 
