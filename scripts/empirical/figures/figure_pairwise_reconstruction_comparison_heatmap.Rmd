...
# Save figures
```{r, save figures}
png("./figures/empirical/pairwise_reconstruction_synchronous_transition_comparisons_synchronous_gain_events_heatmap.png", width=8.75, height=7, units="in", res=900)
draw(
  A,
...
png("./figures/empirical/pairwise_reconstruction_synchronous_transition_comparisons_synchronous_loss_events_heatmap.png", width=8.75, height=7, units="in", res=900)
draw(
  B,
  heatmap_legend_list = list(merged_legends),
  annotation_legend_list = NULL
