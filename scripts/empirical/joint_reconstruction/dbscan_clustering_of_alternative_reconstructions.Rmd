...
reduced_eps <- eps * .95
paste0("Chose to left shift eps (eps *.95): ",reduced_eps)
...
paste0("Number of recons: ", length(dbres$cluster ))
paste0("Number of clusters: ", dbres$cluster %>% subset(.!=0) %>% unique %>% length)
