...
pairwise_comps_sync_all$pheno_number <- gsub("alt_recon_","",pairwise_comps_sync_all$phenotype_reconstruction) 

cluster_names <- clustering %>% `names<-`(seq_len(length(.)))

pairwise_comps_sync_all$pheno_cluster <- ifelse(grepl("focal", pairwise_comps_sync_all$pheno_number),
                                               pairwise_comps_sync_all$pheno_number, unname(cluster_names[pairwise_comps_sync_all$pheno_number]))
...
pairwise_comps_sync_all_geno$pheno_number <- gsub("alt_recon_","",pairwise_comps_sync_all_geno$phenotype_reconstruction) 

pairwise_comps_sync_all_geno$pheno_cluster <- ifelse(grepl("focal", pairwise_comps_sync_all_geno$pheno_number),
                                               pairwise_comps_sync_all_geno$pheno_number, unname(cluster_names[pairwise_comps_sync_all_geno$pheno_number]))
